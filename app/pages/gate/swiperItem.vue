...
const modules = [Autoplay, Navigation, EffectCoverflow, Pagination];

const progressWidth = ref(0); // 프로그레스 바 width (%)

// autoplay가 진행될 때마다 호출되는 함수
const onAutoplayTimeLeft = (s, time, progress) => {
  // progress는 1에서 0으로 줄어듭니다.
  // (1 - progress) * 100을 하면 0%에서 100%로 증가하는 값이 됩니다.
  progressWidth.value = (1 - progress) * 100;
};

const paginationConfig = {
  el: '.sb-gate-swiper-controls__pagination-inner',
  type: 'fraction',

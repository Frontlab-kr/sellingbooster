              ...
              >
                <div class="sb-dialog-extension-write-search-list-scroll">
                  ...
                  >
                    ...
                    <div
                      class="sb-dialog-extension-write-search-list-item__input"
                    >
                      <strong>목표 판매 수량</strong>
                      <SbInput placeholder="0" number />
                    </div>
                  </div>
                </div>
              </div>
